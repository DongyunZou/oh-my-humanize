/**
 * Run Oh My Humanize as an ACP (Agent Client Protocol) server over stdio.
 *
...
export default class Acp extends Command {
	static description = "Run Oh My Humanize as an ACP (Agent Client Protocol) server over stdio";
	static strict = false;
