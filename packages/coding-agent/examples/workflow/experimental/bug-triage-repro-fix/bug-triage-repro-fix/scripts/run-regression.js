...
if (typeof command !== "string" || command.trim() === "") {
	throw new Error("bug-triage-repro-fix requires /task.validationCommand before runRegression");
}

const result = await runShell(command);
const outputPath = "workflow-output/regression.md";
await Bun.write(outputPath, evidenceMarkdown("Regression", command, result));
