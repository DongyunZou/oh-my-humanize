...
export interface AfterToolCallResult {
	...
	isError?: boolean;
	/** If provided, replaces whether this tool result terminates the agent loop. */
	terminal?: boolean;
...
export interface AgentToolResult<T = any, _TInput = unknown> {
	...
	isError?: boolean;
	/** Stops the agent loop after this tool result is emitted. Use for final-result tools such as subagent yield. */
	terminal?: boolean;
