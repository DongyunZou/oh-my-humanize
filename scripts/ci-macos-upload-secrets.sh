...
# terminal transcript.
#
# Prepare a directory (default ~/omh-signing) containing:
...
#   OMP_REPO=owner/repo scripts/ci-macos-upload-secrets.sh ~/omh-signing
...
DIR="${DIR:-${OMH_SIGNING_DIR:-${OMP_SIGNING_DIR:-$HOME/omh-signing}}}"
REPO="${OMP_REPO:-humanfia/oh-my-humanize}"
